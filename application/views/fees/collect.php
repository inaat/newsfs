					...
					<div class="invoice">
						<header class="clearfix">
							<div class="row">
								<div class="col-xs-6">
									<div class="ib">
										<img style="width:50px;height:50px;" src="<?=base_url('uploads/app_image/printing-logo.png')?>" alt="skylinewebsloutionCoder Img" />
									</div>
								</div>
						...
						<table class="table invoice-items" id="invoice">
							<thead>
								<tr class="h5 text-dark">
									<th  style="width:100px;"id="cell-id" class="text-weight-semibold hidden-print">
								...
								<tr>
									<td class="hidden-print checked-area">
										<div class="checkbox-replace">
											...
											<a class="btn btn-default btn-circle icon" href="javascript:void(0);" onclick="getpaymentedit('<?php echo $row['id']; ?>')">
	...
	<section class="panel">
		<header class="panel-heading">
			<h4 class="panel-title">
				<i class="far fa-edit"></i> <?php echo translate('edit') . " " . translate('Payment'); ?>
			</h4>
		</header>
		<?php echo form_open('fees/category_edit', array('class' => 'frm-submit')); ?>
			...
			<div id="collect_fees" class="tab-pane">
						<div class="form-group">
							...
							<?php
								echo form_dropdown("fees_type", $typeData, set_value('fees_type'), "class='form-control' id='editfees_type'
								data-plugin-selectTwo data-width='100%' ");
							?>
						...
						<div class="form-group">
							...
							<div class="col-md-6">
								<input type="text" class="form-control" data-plugin-datepicker
								data-plugin-options='{"todayHighlight" : true}' name="date"id="date" value="<?=date('Y-m-d')?>" autocomplete="off" />
								<span class="error"></span>
							</div>
						</div>
						<div class="form-group">
							<label class="col-md-3 control-label"><?=translate('amount')?> <span class="required">*</span></label>
							<div class="col-md-6">
								<input type="text" class="form-control" name="amount" id="editfeeAmount" value="" autocomplete="off" />
								<span class="error"></span>
							</div>
						</div>
						<div class="form-group">
							<label class="col-md-3 control-label"><?=translate('discount')?></label>
							<div class="col-md-6">
								<input type="text" class="form-control"  id="discount_amount" name="discount_amount" value="0" autocomplete="off" />
								<span class="error"></span>
							</div>
						</div>
						<div class="form-group">
						...
						<div class="form-group">
							...
							<div class="col-md-6">
	    						<?php
	    							$payvia_list = $this->app_lib->getSelectList('payment_types');
	    							echo form_dropdown("pay_via", $payvia_list, set_value('pay_via'), "class='form-control' id='payment_method' data-plugin-selectTwo data-width='100%'
	    							data-minimum-results-for-search='Infinity' ");
	    						?>
								<span class="error"></span>
							</div>
						...
						<div class="form-group">
							<label class="col-md-3 control-label"><?=translate('remarks')?></label>
							<div class="col-md-6 mb-md">
								<textarea name="remarks" rows="2" id="remarks" class="form-control" placeholder="<?=translate('write_your_remarks')?>"></textarea>
