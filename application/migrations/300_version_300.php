...
class Migration_Version_300 extends CI_Migration
{
    ...
    public function up()
    {
        ...
        $this->db->query("INSERT INTO `front_cms_home` (`id`, `title`, `subtitle`, `item_type`, `description`, `elements`, `branch_id`, `active`) VALUES
				...
				(5, 'Wellcome To <span>skylinewebsloution</span>', NULL, 'slider', 'Lorem Ipsum is simply dummy text printer took a galley of type and scrambled it to make a type specimen book.', '{\"position\":\"c-left\",\"button_text1\":\"View Services\",\"button_url1\":\"#\",\"button_text2\":\"Learn More\",\"button_url2\":\"#\",\"image\":\"home-slider-1592582779.jpg\"}', 1, 0),
        ...
        $this->db->query("INSERT INTO `front_cms_home_seo` (`id`, `page_title`, `meta_keyword`, `meta_description`, `branch_id`) VALUES
					(1, 'Home', 'skylinewebsloution  Home Page', 'skylinewebsloution - School Management System With CMS', 1);");
        ...
        $this->db->query("INSERT INTO `front_cms_teachers` (`id`, `page_title`, `banner_image`, `meta_description`, `meta_keyword`, `branch_id`) VALUES
				(1, 'Teachers', 'teachers1.jpg', 'skylinewebsloution - School Management System With CMS', '', 1);");
