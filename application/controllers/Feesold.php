...
class Fees extends Admin_Controller
{
    ...
    public function fee_add()
    {
        ...
        //$this->form_validation->set_rules('amount', translate('amount'), array('trim','required','numeric','greater_than[-1]',array('deposit_verify', array($this->fees_model, 'depositAmountVerify'))));
