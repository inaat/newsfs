...
class Fees extends Admin_Controller
{
    ...
    public function fee_add()
    {
       ...
       $this->form_validation->set_rules('amount', translate('amount'), array('trim','required','numeric'));
 ...
 // student paymentDetails details send by ajax
 public function paymentDetails()
 {
     if (get_permission('student_category', 'is_edit')) {
         ...
         $result = $this->fees_model->getPaymentEdit($id);
         //print_r($result);
